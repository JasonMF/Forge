  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-3.5 flex items-center justify-between">
        {/* Logo */}
        <button onClick={() => onNav("landing")} className="flex items-center gap-2.5 focus-ring rounded-lg">
          <div
            className="w-8 h-8 rounded-lg flex items-center justify-center"
            ...
            {open && (
              ...
              >
                <div className="px-4 py-3 border-b" style={{ borderColor: "var(--border)" }}>
                  <div className="text-sm font-medium">Brandon Doe</div>
                  <div className="text-xs" style={{ color: "var(--text-subtle)" }}>brandon@students.edu</div>
                </div>
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        >
          <h1 className="font-display font-semibold tracking-tight" style={{ fontSize: "clamp(24px, 3vw, 34px)", lineHeight: 1.1 }}>
            Welcome back, <span className="grad-text">Brandon</span>.
          </h1>
